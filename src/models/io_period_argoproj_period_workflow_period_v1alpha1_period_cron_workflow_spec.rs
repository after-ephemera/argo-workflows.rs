...
pub struct IoPeriodArgoprojPeriodWorkflowPeriodV1alpha1PeriodCronWorkflowSpec {
    ...
    pub workflow_metadata: Option<Box<crate::models::IoPeriodK8sPeriodApimachineryPeriodPkgPeriodApisPeriodMetaPeriodV1PeriodObjectMeta>>,
    #[serde(rename = "workflowSpec")]
    pub workflow_spec: Box<crate::models::IoPeriodArgoprojPeriodWorkflowPeriodV1alpha1PeriodWorkflowSpec>,
}

impl IoPeriodArgoprojPeriodWorkflowPeriodV1alpha1PeriodCronWorkflowSpec {
    /// CronWorkflowSpec is the specification of a CronWorkflow
    pub fn new(schedule: String, workflow_spec: crate::models::IoPeriodArgoprojPeriodWorkflowPeriodV1alpha1PeriodWorkflowSpec) -> IoPeriodArgoprojPeriodWorkflowPeriodV1alpha1PeriodCronWorkflowSpec {
