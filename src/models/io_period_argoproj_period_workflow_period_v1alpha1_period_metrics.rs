...
pub struct IoPeriodArgoprojPeriodWorkflowPeriodV1alpha1PeriodMetrics {
    ...
    pub prometheus: Vec<crate::models::IoPeriodArgoprojPeriodWorkflowPeriodV1alpha1PeriodPrometheus>,
}

impl IoPeriodArgoprojPeriodWorkflowPeriodV1alpha1PeriodMetrics {
    /// Metrics are a list of metrics emitted from a Workflow/Template
    pub fn new(prometheus: Vec<crate::models::IoPeriodArgoprojPeriodWorkflowPeriodV1alpha1PeriodPrometheus>) -> IoPeriodArgoprojPeriodWorkflowPeriodV1alpha1PeriodMetrics {
