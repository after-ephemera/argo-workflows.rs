...
pub struct IoPeriodArgoprojPeriodEventsPeriodV1alpha1PeriodKafkaEventSource {
    ...
    pub consumer_group: Option<Box<crate::models::IoPeriodArgoprojPeriodEventsPeriodV1alpha1PeriodKafkaConsumerGroup>>,
    ...
    pub sasl: Option<Box<crate::models::IoPeriodArgoprojPeriodEventsPeriodV1alpha1PeriodSaslConfig>>,
...
impl IoPeriodArgoprojPeriodEventsPeriodV1alpha1PeriodKafkaEventSource {
    pub fn new() -> IoPeriodArgoprojPeriodEventsPeriodV1alpha1PeriodKafkaEventSource {
