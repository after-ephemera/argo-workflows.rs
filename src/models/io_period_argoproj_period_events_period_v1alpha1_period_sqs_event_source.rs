...
pub struct IoPeriodArgoprojPeriodEventsPeriodV1alpha1PeriodSqsEventSource {
    ...
    pub session_token: Option<Box<crate::models::IoPeriodK8sPeriodApiPeriodCorePeriodV1PeriodSecretKeySelector>>,
...
impl IoPeriodArgoprojPeriodEventsPeriodV1alpha1PeriodSqsEventSource {
    pub fn new() -> IoPeriodArgoprojPeriodEventsPeriodV1alpha1PeriodSqsEventSource {
