...
pub struct IoPeriodK8sPeriodApiPeriodCorePeriodV1PeriodScaleIoVolumeSource {
    ...
    pub secret_ref: Box<crate::models::IoPeriodK8sPeriodApiPeriodCorePeriodV1PeriodLocalObjectReference>,
...
impl IoPeriodK8sPeriodApiPeriodCorePeriodV1PeriodScaleIoVolumeSource {
    ...
    pub fn new(gateway: String, secret_ref: crate::models::IoPeriodK8sPeriodApiPeriodCorePeriodV1PeriodLocalObjectReference, system: String) -> IoPeriodK8sPeriodApiPeriodCorePeriodV1PeriodScaleIoVolumeSource {
