...
pub struct IoPeriodArgoprojPeriodWorkflowPeriodV1alpha1PeriodWorkflowStatus {
    ...
    pub artifact_gc_status: Option<Box<crate::models::IoPeriodArgoprojPeriodWorkflowPeriodV1alpha1PeriodArtGcStatus>>,
    #[serde(rename = "artifactRepositoryRef", skip_serializing_if = "Option::is_none")]
    pub artifact_repository_ref: Option<Box<crate::models::IoPeriodArgoprojPeriodWorkflowPeriodV1alpha1PeriodArtifactRepositoryRefStatus>>,
    ...
    pub conditions: Option<Vec<crate::models::IoPeriodArgoprojPeriodWorkflowPeriodV1alpha1PeriodCondition>>,
    ...
    pub nodes: Option<::std::collections::HashMap<String, crate::models::IoPeriodArgoprojPeriodWorkflowPeriodV1alpha1PeriodNodeStatus>>,
    ...
    pub persistent_volume_claims: Option<Vec<crate::models::IoPeriodK8sPeriodApiPeriodCorePeriodV1PeriodVolume>>,
    ...
    pub stored_templates: Option<::std::collections::HashMap<String, crate::models::IoPeriodArgoprojPeriodWorkflowPeriodV1alpha1PeriodTemplate>>,
    #[serde(rename = "storedWorkflowTemplateSpec", skip_serializing_if = "Option::is_none")]
    pub stored_workflow_template_spec: Option<Box<crate::models::IoPeriodArgoprojPeriodWorkflowPeriodV1alpha1PeriodWorkflowSpec>>,
    #[serde(rename = "synchronization", skip_serializing_if = "Option::is_none")]
    pub synchronization: Option<Box<crate::models::IoPeriodArgoprojPeriodWorkflowPeriodV1alpha1PeriodSynchronizationStatus>>,
}
