...
pub struct IoPeriodArgoprojPeriodWorkflowPeriodV1alpha1PeriodMemoize {
    #[serde(rename = "cache")]
    pub cache: Box<crate::models::IoPeriodArgoprojPeriodWorkflowPeriodV1alpha1PeriodCache>,
...
impl IoPeriodArgoprojPeriodWorkflowPeriodV1alpha1PeriodMemoize {
    ...
    pub fn new(cache: crate::models::IoPeriodArgoprojPeriodWorkflowPeriodV1alpha1PeriodCache, key: String, max_age: String) -> IoPeriodArgoprojPeriodWorkflowPeriodV1alpha1PeriodMemoize {
