...
pub struct IoPeriodArgoprojPeriodWorkflowPeriodV1alpha1PeriodArtifact {
    ...
    pub archive: Option<Box<crate::models::IoPeriodArgoprojPeriodWorkflowPeriodV1alpha1PeriodArchiveStrategy>>,
    ...
    pub artifact_gc: Option<Box<crate::models::IoPeriodArgoprojPeriodWorkflowPeriodV1alpha1PeriodArtifactGc>>,
