...
pub struct IoPeriodArgoprojPeriodWorkflowPeriodV1alpha1PeriodOAuth2Auth {
    ...
    pub client_id_secret: Option<Box<crate::models::IoPeriodK8sPeriodApiPeriodCorePeriodV1PeriodSecretKeySelector>>,
    #[serde(rename = "clientSecretSecret", skip_serializing_if = "Option::is_none")]
    pub client_secret_secret: Option<Box<crate::models::IoPeriodK8sPeriodApiPeriodCorePeriodV1PeriodSecretKeySelector>>,
    #[serde(rename = "endpointParams", skip_serializing_if = "Option::is_none")]
    pub endpoint_params: Option<Vec<crate::models::IoPeriodArgoprojPeriodWorkflowPeriodV1alpha1PeriodOAuth2EndpointParam>>,
    #[serde(rename = "scopes", skip_serializing_if = "Option::is_none")]
    pub scopes: Option<Vec<String>>,
    #[serde(rename = "tokenURLSecret", skip_serializing_if = "Option::is_none")]
    pub token_url_secret: Option<Box<crate::models::IoPeriodK8sPeriodApiPeriodCorePeriodV1PeriodSecretKeySelector>>,
}
