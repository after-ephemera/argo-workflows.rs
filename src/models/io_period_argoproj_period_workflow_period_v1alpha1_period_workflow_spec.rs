...
pub struct IoPeriodArgoprojPeriodWorkflowPeriodV1alpha1PeriodWorkflowSpec {
    ...
    pub artifact_gc: Option<Box<crate::models::IoPeriodArgoprojPeriodWorkflowPeriodV1alpha1PeriodWorkflowLevelArtifactGc>>,
    #[serde(rename = "artifactRepositoryRef", skip_serializing_if = "Option::is_none")]
    pub artifact_repository_ref: Option<Box<crate::models::IoPeriodArgoprojPeriodWorkflowPeriodV1alpha1PeriodArtifactRepositoryRef>>,
    ...
    pub dns_config: Option<Box<crate::models::IoPeriodK8sPeriodApiPeriodCorePeriodV1PeriodPodDnsConfig>>,
    ...
    pub executor: Option<Box<crate::models::IoPeriodArgoprojPeriodWorkflowPeriodV1alpha1PeriodExecutorConfig>>,
    ...
    pub hooks: Option<::std::collections::HashMap<String, crate::models::IoPeriodArgoprojPeriodWorkflowPeriodV1alpha1PeriodLifecycleHook>>,
    #[serde(rename = "hostAliases", skip_serializing_if = "Option::is_none")]
    pub host_aliases: Option<Vec<crate::models::IoPeriodK8sPeriodApiPeriodCorePeriodV1PeriodHostAlias>>,
    ...
    pub metrics: Option<Box<crate::models::IoPeriodArgoprojPeriodWorkflowPeriodV1alpha1PeriodMetrics>>,
    ...
    pub pod_disruption_budget: Option<Box<crate::models::IoPeriodK8sPeriodApiPeriodPolicyPeriodV1PeriodPodDisruptionBudgetSpec>>,
    #[serde(rename = "podGC", skip_serializing_if = "Option::is_none")]
    pub pod_gc: Option<Box<crate::models::IoPeriodArgoprojPeriodWorkflowPeriodV1alpha1PeriodPodGc>>,
    #[serde(rename = "podMetadata", skip_serializing_if = "Option::is_none")]
    pub pod_metadata: Option<Box<crate::models::IoPeriodArgoprojPeriodWorkflowPeriodV1alpha1PeriodMetadata>>,
    ...
    pub retry_strategy: Option<Box<crate::models::IoPeriodArgoprojPeriodWorkflowPeriodV1alpha1PeriodRetryStrategy>>,
    ...
    pub synchronization: Option<Box<crate::models::IoPeriodArgoprojPeriodWorkflowPeriodV1alpha1PeriodSynchronization>>,
    #[serde(rename = "templateDefaults", skip_serializing_if = "Option::is_none")]
    pub template_defaults: Option<Box<crate::models::IoPeriodArgoprojPeriodWorkflowPeriodV1alpha1PeriodTemplate>>,
    /// Templates is a list of workflow templates used in a workflow
    #[serde(rename = "templates", skip_serializing_if = "Option::is_none")]
    pub templates: Option<Vec<crate::models::IoPeriodArgoprojPeriodWorkflowPeriodV1alpha1PeriodTemplate>>,
    ...
    pub ttl_strategy: Option<Box<crate::models::IoPeriodArgoprojPeriodWorkflowPeriodV1alpha1PeriodTtlStrategy>>,
    #[serde(rename = "volumeClaimGC", skip_serializing_if = "Option::is_none")]
    pub volume_claim_gc: Option<Box<crate::models::IoPeriodArgoprojPeriodWorkflowPeriodV1alpha1PeriodVolumeClaimGc>>,
    /// VolumeClaimTemplates is a list of claims that containers are allowed to reference. The Workflow controller will create the claims at the beginning of the workflow and delete the claims upon completion of the workflow
    #[serde(rename = "volumeClaimTemplates", skip_serializing_if = "Option::is_none")]
    pub volume_claim_templates: Option<Vec<crate::models::IoPeriodK8sPeriodApiPeriodCorePeriodV1PeriodPersistentVolumeClaim>>,
    ...
    pub workflow_metadata: Option<Box<crate::models::IoPeriodArgoprojPeriodWorkflowPeriodV1alpha1PeriodWorkflowMetadata>>,
    #[serde(rename = "workflowTemplateRef", skip_serializing_if = "Option::is_none")]
    pub workflow_template_ref: Option<Box<crate::models::IoPeriodArgoprojPeriodWorkflowPeriodV1alpha1PeriodWorkflowTemplateRef>>,
}
