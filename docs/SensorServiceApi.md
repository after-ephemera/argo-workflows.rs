...
> crate::models::IoPeriodArgoprojPeriodEventsPeriodV1alpha1PeriodSensor sensor_service_create_sensor(namespace, body)
...
[**crate::models::IoPeriodArgoprojPeriodEventsPeriodV1alpha1PeriodSensor**](io.argoproj.events.v1alpha1.Sensor.md)
...
> crate::models::IoPeriodArgoprojPeriodEventsPeriodV1alpha1PeriodSensor sensor_service_get_sensor(namespace, name, get_options_period_resource_version)
...
[**crate::models::IoPeriodArgoprojPeriodEventsPeriodV1alpha1PeriodSensorList**](io.argoproj.events.v1alpha1.SensorList.md)
...
**pod_log_options_period_tail_lines** | Option<**String**> | If set, the number of lines from the end of the logs to show. If not specified, logs are shown from the creation of the container or sinceSeconds or sinceTime +optional. |  |
...
> crate::models::IoPeriodArgoprojPeriodEventsPeriodV1alpha1PeriodSensor sensor_service_update_sensor(namespace, name, body)
...
> crate::models::StreamResultOfSensorSensorWatchEvent sensor_service_watch_sensors(namespace, list_options_period_label_selector, list_options_period_field_selector, list_options_period_watch, list_options_period_allow_watch_bookmarks, list_options_period_resource_version, list_options_period_resource_version_match, list_options_period_timeout_seconds, list_options_period_limit, list_options_period_continue)
